...
from ..extractors import iqiyi_series_extractor


class IqiyiSeriesSpider(BaseSpider):

    name = 'iqiyi_series'
    extractor = iqiyi_series_extractor
    download_delay = 0.1
    start_urls = ["http://www.iqiyi.com/lib/dianshiju/,,_11_1.html"]
    rules = (
        # Find series indexes for all categories
        Rule(LinkExtractor(allow=(
            'http://www.iqiyi.com/lib/dianshiju/[^,]*,[^,]*,[^,]*_11_\d+.html',
        ))),
        # Find series pages
